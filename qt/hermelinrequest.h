...
#ifndef HERMELINREQUEST_H
#define HERMELINREQUEST_H
...
class HermelinRequest : public QObject
{
    Q_OBJECT
public:
    HermelinRequest(const QString& uuid,
    ...
    bool doRequest();
Q_SIGNALS:
    void requestFinished(HermelinRequest* request, QByteArray result, QString uuid, bool hasError);
protected Q_SLOTS:
    void finished();
private:
