...
ui.Welcome = {
  ...
  init: function init() {
    ...
    $('#tbox_basic_auth_password').blur(function (event) {
    ...
    $('#btn_welcome_delete_profile').click(function (event) {
    ...
    $('#btn_welcome_about').click(function (event) {
  ...
  create_profile: function create_profile() {
  ...
  oauth_sign_in: function oauth_sign_in(event) {
  ...
  basic_auth_sign_in: function basic_auth_sign_in(event) {
    globals.twitterClient.username = $('#tbox_basic_auth_username').attr('value');
    globals.twitterClient.password = $('#tbox_basic_auth_password').attr('value');
  ...
  load_profiles_info: function load_profiles_info() {
    ...
    $('#profile_avatar_list a').click(function (event) {
      ...
      $('#sign_in_block .inner').stop().transition({
        'width': width_per_page[type]
      }, 200);
      if (profile_name == 'default') {
  ...
  authenticate_pass: function authenticate_pass(result) {
  ...
  load_daily_hint: function load_daily_hint() {
    if (Date.now() % 4 != 0) {
  ...
  load_background: function load_background(url) {
    if (url != '') {
      $('#welcome_page').css({
