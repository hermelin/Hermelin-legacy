...
ui.ProfileDlg = {
  ...
  init: function init() {
    ...
    $('#tbox_profile_name').keyup(function (event) {
      ui.ProfileDlg.limit_test(this, 20);
      return false;
    });
    $('#tbox_profile_location').keyup(function (event) {
      ui.ProfileDlg.limit_test(this, 100);
      return false;
    });
    $('#tbox_profile_website').keyup(function (event) {
      ui.ProfileDlg.limit_test(this, 30);
      return false;
    });
    $('#tbox_profile_bio').keyup(function (event) {
      ui.ProfileDlg.limit_test(this, 160);
      return false;
    });
  },

  limit_test: function limit_test(widget, limit) {
  ...
  update_profile: function update_profile() {
    ...
    globals.twitterClient.update_profile(name, website, location, bio, function (result) {
  ...
  request_profile: function request_profile() {
  ...
  update_avatar: function update_avatar(file) {
    ...
    reader.onload = function (e) {
      ...
      globals.twitterClient.update_profile_image(file, result, function (ret) {
        globals.myself = ret;
