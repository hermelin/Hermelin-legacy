...
ui.RetweetView = {
  ...
  load_retweeted_to_me: function load_retweeted_to_me(view, success, fail) {
    globals.twitterClient.get_retweeted_to_me(
      view.since_id, null, conf.vars.items_per_request, success);
  },

  loadmore_retweeted_to_me: function loadmore_retweeted_to_me(view, success, fail) {
    globals.twitterClient.get_retweeted_to_me(
      null, view.max_id, conf.vars.items_per_request, success);
  },

  load_retweeted_by_me: function load_retweeted_by_me(view, success, fail) {
    globals.twitterClient.get_retweeted_by_me(
      view.since_id, null, conf.vars.items_per_request, success);
  },

  loadmore_retweeted_by_me: function loadmore_retweeted_by_me(view, success, fail) {
    globals.twitterClient.get_retweeted_by_me(
      null, view.max_id, conf.vars.items_per_request, success);
  },

  load_retweets_of_me: function load_retweets_of_me(view, success, fail) {
    globals.twitterClient.get_retweets_of_me(
      view.since_id, null, conf.vars.items_per_request, success);
  },

  loadmore_retweets_of_me: function load(view, success, fail) {
    globals.twitterClient.get_retweets_of_me(
      null, view.max_id, conf.vars.items_per_request, success);
  }
