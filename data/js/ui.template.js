...
<div class="list_lock_hint"> \
  ...
  retweets_header_t: '<div class="header_frame"><div class="retweets_view_toggle"> \
...
',
  ...
  form_text: function form_text(tweet) {
    ...
    text = text.replace(ui.Template.reg_hash_tag, '$1<a class="hash_href" href="#$2">#$2</a>');
  ...
  form_preview: function form_preview(tweet) {
    var html_arr = [];
