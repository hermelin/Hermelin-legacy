...
ui.ImageUploader = {
  ...
  pyload: function pyload(filename) {
    ui.ImageUploader.me.find('.preview')
  ...
  pyupload: function pyupload(filename) {
    ...
    globals.network.do_request(
      'POST', ui.ImageUploader.services[service_name].url, params, headers, [['media', ui.ImageUploader.filename]], ui.ImageUploader.success, ui.ImageUploader.fail);
  },
  ...
  upload: function upload(file) {
    ...
    ui.ImageUploader.upload_image(
      ui.ImageUploader.services[service_name].url, params, file, ui.ImageUploader.success, ui.ImageUploader.fail);
  },
  ...
  upload_image_official: function upload_image_official(params, file, success, fail) {
  ...
  upload_image_oauth_echo: function upload_image_oauth_echo(url, params, file, success, fail) {
    ...
    if (ui.ImageUploader.mode == ui.ImageUploader.MODE_HTML5) {
      ...
      reader.onload = function (e) {
        ...
        globals.network.do_request(
          'POST', url, params, headers, ret[1], success, fail);
      }
      reader.readAsArrayBuffer(file);
    } else {
      globals.network.do_request(
        'POST', url, params, headers, [['media', ui.ImageUploader.filename]], ui.ImageUploader.success, ui.ImageUploader.fail);
    }
  },
  ...
  show: function show() {
    ...
    ui.ImageUploader.me.find('.service[href="#' + ui.ImageUploader.service_name + '"]').addClass('selected');
