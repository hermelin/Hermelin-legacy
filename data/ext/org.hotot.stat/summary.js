var user = {
  update_tweet: function update_tweet(data) {
    var d = [];
  ...
  update_stat: function update_stat(data) {
    var hour_d = [],
      day_d = [];
  ...
  update_top_talkers: function update_top_talkers(talkers) {
    var data = [0];
    var ticks = [0];
  ...
  update_top_rt_users: function update_top_rt_users(talkers) {
    var data = [0];
    var ticks = [0];
    for (var i = 0; i < talkers.length; i += 1) {
      data.push([i + 0.5, talkers[i][1]]);
  ...
  update_top_clients: function update_top_clients(clients) {
    var d = [];
    for (var i = 0; i < clients.length; i += 1) {
      d.push({
        label: clients[i][0] + ':' + clients[i][1],
        data: clients[i][1]
      });
    }
  ...
  update_follower_trend: function update_follower_trend(follower_stream) {
    var data = [0];
...
var home = {
  update_top_speakers: function update_top_speakers(user) {
    var data = [0];
    var ticks = [0];
