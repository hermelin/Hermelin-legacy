#
# spec file for package hermelin
#
...
%description
Hermelin is a multi-column microblogging client written by HTML5 technologies through Webkit, thus can run on any device supports webkit(Currently runs on Windows/Linux/Mac OS X/Google Chrome/QT Mobiles).
...
This package provides Hermelin QT edition with KDE integration.

%package data
Summary: A lightweight, flexible microblogging client
Group:  Productivity/Networking/Instant Messenger
Recommends: hermelin-gtk = %{version}
Recommends: hermelin-gir = %{version}
Recommends: hermelin-qt = %{version}
...
/Locales/Extensions/Sound) for Hermelin.
...
This package provides Hermelin GTK2 edition.
...
This package provides Hermelin GTK3 edition with Gir.
%endif
%else
...
sed -i "s/Categories=Qt;Network;/Categories=Qt;Network;InstantMessaging;/" misc/hermelin-qt.desktop.in
...
%{_datadir}/kde4/apps/desktoptheme/default/icons/hermelin_qt.svg
