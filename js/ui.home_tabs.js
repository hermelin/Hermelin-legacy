...
ui.HomeTabs = {
  ...
  get_non_public_tweets: function get_non_public_tweets(tweets) {
    return $($.grep(tweets, function (obj, i) {
      return $(obj).attr('reply_name') != '';
    }));
  },

  get_public_tweets: function get_public_tweets(tweets) {
    return $($.grep(tweets, function (obj, i) {
      return $(obj).attr('reply_name') == '';
    }));
  },
  ...
  apply_filter: function apply_filter() {
    ...
    case '#public':
      ui.HomeTabs.get_non_public_tweets(
        $('#home_timeline_tweet_block .card:visible')).hide();
