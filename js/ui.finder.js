...
ui.Finder = {
  ...
  init: function init() {
    ...
    $(ui.Finder.tbox).keyup(function (event) {
    ...
    $('#btn_finder_next').click(function (event) {
      ui.Finder.next_result();
      return false;
    });
    $('#btn_finder_prev').click(function (event) {
      ui.Finder.prev_result();
      return false;
    });
    $('#btn_finder_close').click(function (event) {
      ui.Finder.clear();
      ui.Finder.hide();
      return false;
    });
  ...
  next_result: function next_result() {
    ...
    if (ui.Finder.matched_ids.length == 0) {
      ...
      $('#finder_matched_info').text((ui.Finder.current_pos + 1) + ' of ' + ui.Finder.matched_ids.length);
    }
  },

  prev_result: function prev_result() {
    ui.Finder.current_pos -= 1;
