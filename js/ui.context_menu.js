...
ui.ContextMenu = {
  ...
  init: function init() {
    $('#context_menuitem_copy').click(function (event) {
    ...
    $('#context_menuitem_paste').click(function (event) {
    ...
    $('#context_menuitem_web_search').click(function (event) {
      navigate_action('http://www.google.com/search?sourceid=chrome&ie=UTF-8&q=' + ui.ContextMenu.selected_string);
    });

    $('#context_menuitem_twitter_search').click(function (event) {
    ...
    $('body').get(0).oncontextmenu = function (event) {
      ...
      ui.ContextMenu.selected_string = $.trim(document.getSelection().toString());
      ...
      $('#context_menu a').each(function (idx, item) {
